<div class="py-12 max-w-4xl mx-auto px-4"
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mt-6">
        ...
        <div class="md:col-span-7">
    <div
        class="bg-[#FDF8ED] border border-[#E3D3AC] rounded-2xl p-6 sm:p-8 shadow-sm relative overflow-hidden">
        ...
        <div class="relative">
            ...
            <div class="rounded-2xl border border-[#E3B8B8] bg-[#FFF5F5] p-6 sm:p-7">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    {{-- Icon --}}
                    <div
                        class="w-16 h-16 rounded-full bg-[#C1272D]/10 flex items-center justify-center mb-5">
                        <svg class="w-8 h-8 text-[#C1272D]" fill="none"
                    ...
                    <div class="w-full rounded-xl bg-white border border-[#E3D3AC] p-5 text-left">
                        ...
                        <div class="flex items-start gap-3">
                            <div
                                ...
                                <svg class="w-5 h-5 text-[#8A6A2F]" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round"
                                        stroke-linejoin="round"
                                        stroke-width="1.8"
